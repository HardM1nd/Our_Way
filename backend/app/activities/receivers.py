...
@receiver(reward_claimed) 
     def on_reward_claimed(sender, reward=None, user=None, **kwargs): # notify user from app.core.services import NotificationService try: NotificationService.send(user, f'Reward claimed: {reward.type} for activity {getattr(reward.activity, "title", "?")}') except Exception: pass
>>>>>>> 42d1e4eafb58dc94b76523a17decb7ed33538154
